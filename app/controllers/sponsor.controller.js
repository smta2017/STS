...
class Sponsor {
    static add = (req, res) => {
        try {
            let image
            const upload = uploadfile('sponsor_posters',['image/png','image/webp','image/apng','image/gif'])
            ...
            uploadImage(req, res, async function (e) {
                if (e instanceof multer.MulterError)
                    ...
                    try {
                        ...
                        // }
                        Helper.formatMyAPIRes(res, 200, true, { file: req.file, sponsor }, 'you added new sponsor successfully')
                    }
                    catch (e) {
                        console.log(e)
