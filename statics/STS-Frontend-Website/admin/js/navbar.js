...
function editProfile() {
  document.getElementById("editFirstNameForAdmin").value =
    getCookie("firstName");
...
function profileModified(e) {
  ...
  var CountryCode = selectOption.textContent
    .split(" ")
    .pop()
    .match(/\d+/g)
    .join("");
  ...
  const formEditProfile = {
    user: {
      firstName: document.getElementById("editFirstNameForAdmin").value
        ? document.getElementById("editFirstNameForAdmin").value
        : undefined,
      lastName: document.getElementById("editLastNameForAdmin").value
        ? document.getElementById("editLastNameForAdmin").value
        : undefined,
      countryCallingCode: `+${CountryCode}` ? `+${CountryCode}` : undefined,
      mobileNumber: document.getElementById("editMobileNumbeForAdmin").value
        ? document.getElementById("editMobileNumbeForAdmin").value
        : undefined,
      email: document.getElementById("editEmailForAdmin").value
  ...
  try {
    ...
    fetch(`${domainName}/sts/user`, {
      ...
      .then((data) => {
        if (
          data.apiMessage &&
          data.apiMessage.includes("no password to log you in")
        ) {
          alert(
            "There is no password to log you in. Please enter your password."
          );
        } else {
          ...
          document.getElementById("callingCodeForMyProfile").value = "";
          document.getElementById("editMobileNumbeForAdmin").value = "";
          document.getElementById("editEmailForAdmin").value = "";
          document.getElementById("editOldPassword").value = "";
          document.getElementById("newPassword").value = "";
      ...
      .catch((error) => {
        if (error.message.includes("400")) {
          alert(
            "There was a bad request. Please check your input and try again."
          );
        } else {
          console.log(
...
// function getAllTabs() {
//   const elementUl = document.getElementById("loka");
//   const elementUlDrop = document.getElementById("loka2");

//   var roleID = getCookie("role");
//   document.getElementById("gif").style.display = "block";
//   fetch(`${domainName}/sts/role/${roleID}`, {
//     method: "GET",
...
//         elementIcon = document.createElement("li");
//         elementIcon.className = "nav-item";
//         const elementA = document.createElement("a");
//         elementA.className = "nav-link";
//         elementA.href = `#${element.tabName}`;
//         elementA.id = `${element.tabId}`;
//         elementA.innerHTML = `${element.tabName}`;
//         elementIcon.appendChild(elementA);
//         elementUl.appendChild(elementIcon);
//       });
//       ///////////////////////Add Employee/////////////////////
//       const elementIconEmployee = document.createElement("li");
//       const elementAEmployee = document.createElement("a");
//       elementAEmployee.className = "dropdown-item";
//       elementAEmployee.href = "#addingEmployee";
//       elementAEmployee.id = "addingEmployee";
//       elementAEmployee.innerHTML = "Add Employee";
//       elementIconEmployee.appendChild(elementAEmployee);
//       elementUlDrop.insertBefore(elementIconEmployee, elementUlDrop.firstChild);
//       ///////////////////////Add Position/////////////////////
//       const elementIconPosition = document.createElement("li");
//       const elementAPosition = document.createElement("a");
//       elementAPosition.className = "dropdown-item";
//       elementAPosition.href = "#addingPosition";
//       elementAPosition.id = "addingPosition";
//       elementAPosition.innerHTML = "Add Position";
//       elementIconPosition.appendChild(elementAPosition);
//       elementUlDrop.insertBefore(elementIconPosition, elementUlDrop.firstChild);
